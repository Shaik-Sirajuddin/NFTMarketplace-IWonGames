        ...
        <div className='row w-100-nav'>
          ...
          <BreakpointProvider>
            <Breakpoint l down>
              {showmenu &&
                <div className='menu'>
                  ...
                  <div className='navbar-item'>
                    <NavLink to="/game2" onClick={() => btn_icon(!showmenu)}>
                      Game 2
                      <span className='lines'></span>
                    </NavLink>
                  </div>
                  <div className='navbar-item'>
                    <NavLink to="/game3" onClick={() => btn_icon(!showmenu)}>
                      Game 3
                      <span className='lines'></span>
                    </NavLink>
                  </div>
                  ...
                  <NavLink to="/buySell" onClick={() => btn_icon(!showmenu)}>
                    My NFT's
                    <span className='lines'></span>
                  </NavLink>
                  <div className='navbar-item'>
            ...
            <Breakpoint xl>
              <div className='menu'>
                <div className='navbar-item'>
                      <NavLink to="/" onClick={() => btn_icon(!showmenu)}>Game 1
                        <span className='lines'></span>
                      </NavLink>
                </div>
                <div className='navbar-item'>
